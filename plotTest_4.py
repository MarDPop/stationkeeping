...
for i in idxe:
    ...
    rE = getX(time,T_E,X_E,Y_E,Z_E)
    rM = getX(time,T_M,X_M,Y_M,Z_M)
    ...
    rE = getX(time+600,T_E,X_E,Y_E,Z_E)
    rM = getX(time+600,T_M,X_M,Y_M,Z_M)
